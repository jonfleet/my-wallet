...
class Expense extends Form {
  ...
  render() {
    const { categories, days, months, years, accounts, errors } = this.state;
    ...
    return (
      <div className="bg-light rounded p-3 m-3 expense-container-position">
        <div>
          <div className="m-2">
            <p className="h1">
              <span className="badge badge-primary">New Expense</span>
            </p>
          </div>
